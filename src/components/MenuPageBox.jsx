                                    ...
                                    <h3 className='text-xs md:text-sm lg:text-xl text-Gray-8 font-EstedadRegular lg:font-EstedadBold'>{title}</h3>
                                    {
                                        isLogin && (
                                            <svg onClick={() => {
                                                setIsAlert('warning')
                                                setAlertMsg('بزودی')
                                            }} className='w-6 h-6 hidden lg:block cursor-pointer' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='flex items-center justify-between gap-x-2'>
                                        {
                                            isLogin && (
                                                <svg onClick={() => {
                                                    setIsAlert('warning')
                                                    setAlertMsg('بزودی')
                                                }} className='w-4 h-4 block lg:hidden' viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
