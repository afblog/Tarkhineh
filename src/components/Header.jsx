                ...
                <div className='container'>
                            ...
                            </Link>
                            {
                                !isLogin ? (<Link to='/login' className='p-1 lg:p-2 rounded-sm bg-Tint-1 group hover:bg-Primary transition-all'>
                                    ...
                                    <div className='h-14 flex items-center group'>
                                        <div className={`relative group-hover:bg-Primary transition-all rounded-sm ${isProfilePage ? "bg-Primary" : "bg-Tint-1"}`}>
                                            <div onClick={() => {
                                                userProfilHandler()
                                                navigate('/profile')
                                            }} className='flex items-center gap-x-1 p-1 lg:p-2 cursor-pointer'>
                                                <svg className={`w-6 h-6 ${isProfilePage ? "text-white" : "text-Primary"} group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 12.75C8.83 12.75 6.25 10.17 6.25 7C6.25 3.83 8.83 1.25 12 1.25C15.17 1.25 17.75 3.83 17.75 7C17.75 10.17 15.17 12.75 12 12.75ZM12 2.75C9.66 2.75 7.75 4.66 7.75 7C7.75 9.34 9.66 11.25 12 11.25C14.34 11.25 16.25 9.34 16.25 7C16.25 4.66 14.34 2.75 12 2.75Z" fill="currentColor" />
                                                    <path d="M20.5901 22.75C20.1801 22.75 19.8401 22.41 19.8401 22C19.8401 18.55 16.3202 15.75 12.0002 15.75C7.68015 15.75 4.16016 18.55 4.16016 22C4.16016 22.41 3.82016 22.75 3.41016 22.75C3.00016 22.75 2.66016 22.41 2.66016 22C2.66016 17.73 6.85015 14.25 12.0002 14.25C17.1502 14.25 21.3401 17.73 21.3401 22C21.3401 22.41 21.0001 22.75 20.5901 22.75Z" fill="currentColor" />
                                                </svg>
                                                {
                                                    !isProfilePage && (
                                                        <svg className={`rotate-180 group-hover:rotate-0 ${isProfilePage ? "text-white" : "text-Primary"} group-hover:text-white transition-all`} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </div>
                                            {
                                                !isProfilePage && (
                                                    <>
                                                        <div className='hidden group-hover:flex flex-col gap-y-2 absolute top-12 left-0 z-40 divide-y divide-Gray-3 w-36 bg-white rounded-sm shadow-loginBox delay-150 transition-all'>
                                                            <Link to='/profile' onClick={userProfilHandler} className='flex items-center gap-x-1 text-Gray-8 p-2 hover:text-Primary'>
                                                            ...
                                                            <Link to='/profile' onClick={userOrderHandler} className='flex items-center gap-x-1 text-Gray-8 p-2 hover:text-Primary'>
                                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <Link to="/profile" onClick={userInterestsHandler} className='flex items-center gap-x-1 text-Gray-8 p-2 hover:text-Primary'>
                                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div onClick={() => {
                                                                logoutHandler()
                                                                navigate('/')
                                                            }} className='flex items-center gap-x-1 text-Error cursor-pointer p-2'>
                                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='rtl flex md:hidden items-center justify-between'>
                        ...
                        <div className='flex items-center gap-x-1'>
                            ...
                            {
                                !isLogin ? (
                                    <div className='p-1 lg:p-2 rounded-sm bg-Tint-1'>
